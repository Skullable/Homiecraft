...
//    const link = 'https://api.minetools.eu/uuid/'
//   const skinlink = 'https://visage.surgeplay.com/full/'
    const skinlink = 'https://mineskin.eu/armor/body/'
    const skinlink2 = '/80.png'
  ...
  return (
    ...
    <div className='menu'>
        ...
        <div className="skinwrapper">
            <img src={`${skinlink}${props.name}${skinlink2}`} alt='Skin généré par Minecraft-api.com' className="skin"></img>
